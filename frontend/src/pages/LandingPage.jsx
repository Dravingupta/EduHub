            ...
            <div className="min-h-[calc(100vh-80px)] w-full flex items-center justify-center px-6 py-20 lg:py-0 border-b border-[#262626]">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 w-full max-w-7xl mx-auto items-center">
                    ...
                    <div className="flex flex-col space-y-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            <button
                                ...
                                className="bg-[#C8A24C] text-black font-bold rounded-xl px-8 py-4 hover:bg-[#D4AF57] transition-all hover:scale-105 shadow-[0_0_20px_rgba(200,162,76,0.2)]"
                            >
                                Get Started Free
                            </button>
                            <button
                    ...
                    <div className="flex justify-center lg:justify-end relative">
                        {/* Glow effect */}
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 bg-[#C8A24C] blur-[120px] opacity-10 rounded-full"></div>

                        <div className="bg-[#131313] border border-[#262626] rounded-2xl shadow-2xl p-8 w-full max-w-md relative z-10 backdrop-blur-xl">
            ...
            <div id="features" className="w-full bg-[#0E0E0E] px-6 py-24 border-b border-[#262626]">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {/* FEATURE 1 */}
                        <div className="bg-[#131313] border border-[#262626] rounded-2xl p-8 hover:border-[#444] transition-colors group">
                            <div className="w-14 h-14 rounded-xl bg-indigo-500/10 flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform">
                                ⚡️
                            </div>
                            <h3 className="text-xl font-bold mb-3 text-[#F5F5F5]">Instant Universal Content</h3>
                        ...
                        {/* FEATURE 2 */}
                        <div className="bg-[#131313] border border-[#262626] rounded-2xl p-8 hover:border-[#444] transition-colors group">
                            <div className="w-14 h-14 rounded-xl bg-green-500/10 flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform">
                                🎛️
                            </div>
                            <h3 className="text-xl font-bold mb-3 text-[#F5F5F5]">Adaptive Swap Engine</h3>
                            <p className="text-[#A1A1AA] leading-relaxed">
                        ...
                        {/* FEATURE 3 */}
                        <div className="bg-[#131313] border border-[#262626] rounded-2xl p-8 hover:border-[#444] transition-colors group">
                            <div className="w-14 h-14 rounded-xl bg-purple-500/10 flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform">
                                🖼️
                            </div>
                            <h3 className="text-xl font-bold mb-3 text-[#F5F5F5]">Progressive Visual Delivery</h3>
                            <p className="text-[#A1A1AA] leading-relaxed">
                        ...
                        {/* FEATURE 4 */}
                        <div className="bg-[#131313] border border-[#262626] rounded-2xl p-8 hover:border-[#444] transition-colors group">
                            <div className="w-14 h-14 rounded-xl bg-orange-500/10 flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform">
                                🤖
                            </div>
                            <h3 className="text-xl font-bold mb-3 text-[#F5F5F5]">Inline AI Learning Tutor</h3>
                            <p className="text-[#A1A1AA] leading-relaxed">
                        ...
                        {/* FEATURE 5 */}
                        <div className="bg-[#131313] border border-[#262626] rounded-2xl p-8 hover:border-[#444] transition-colors group">
                            <div className="w-14 h-14 rounded-xl bg-blue-500/10 flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform">
                                📈
                            </div>
                            <h3 className="text-xl font-bold mb-3 text-[#F5F5F5]">Deterministic Mastery</h3>
                            <p className="text-[#A1A1AA] leading-relaxed">
                        ...
                        {/* FEATURE 6 */}
                        <div className="bg-[#131313] border border-[#262626] rounded-2xl p-8 hover:border-[#444] transition-colors group">
                            <div className="w-14 h-14 rounded-xl bg-red-500/10 flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform">
                                🧠
                            </div>
                            <h3 className="text-xl font-bold mb-3 text-[#F5F5F5]">Custom AI Subjects</h3>
                            <p className="text-[#A1A1AA] leading-relaxed">
